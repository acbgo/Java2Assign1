...
public class MovieAnalyzer {
    ...
    public  Map<List<String>, Integer> getCoStarCount(){
        ...
        for (Movie m : movies){
            ...
            list1.add(star1);list1.add(star2);
            list2.add(star1);list2.add(star3);
            list3.add(star1);list3.add(star4);
    ...
    public static List<Map.Entry<String, Double>> sort(Map<String,Double> map, Map<String,Integer> star_count){
